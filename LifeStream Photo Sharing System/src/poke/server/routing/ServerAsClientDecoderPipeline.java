...
public class ServerAsClientDecoderPipeline implements ChannelPipelineFactory {

	public ServerAsClientDecoderPipeline() {
	}
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		pipeline.addLast("handler", new ServerAsClientHandler());
