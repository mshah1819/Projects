...
<script src="js/script.js" type="text/javascript"></script>  <title>Welcome to Tommy Hilfiger USA</title>
 </head>
 <body>
   ...
   <tbody>
    ...
    <tr>
     <td width="15%">
      &nbsp;</td>
     <td colspan="5">
      <img src="http://2.bp.blogspot.com/_hbgTa7k4Zv4/TNpfX8iTl4I/AAAAAAAAAlU/_cRiPS3U3TM/s1600/Meet_1.jpg" /></td>
     <td width="15%">
      &nbsp;</td>
    </tr>
