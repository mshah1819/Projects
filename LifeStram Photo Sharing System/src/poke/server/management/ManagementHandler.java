...
/**
 * The purpose of the Management Handler is to accept a monitor request for heartbeat 
 * and put it in the inbound queue 
 * @author root
 *
 */
public class ManagementHandler extends SimpleChannelUpstreamHandler {
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) {
		logger.info("BINGO! message received in the management handler");
		//logger.info("message rcv: " + e.getRemoteAddress());
		logger.info("message rcv from : " + e.getChannel());
